...
import com.example.mobilepint.administracao.FragmentCriarReuniaoOutrosAdmin
...
class FragmentCriarReuniaoOutros : Fragment() {
    ...
    private lateinit var tempoNotificacaoList: ArrayList<FragmentCriarReuniaoOutrosAdmin.ItemsTempoNotificacao>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tempoNotificacaoList = arrayListOf(
            FragmentCriarReuniaoOutrosAdmin.ItemsTempoNotificacao(15, "15 minutos"),
            FragmentCriarReuniaoOutrosAdmin.ItemsTempoNotificacao(30, "30 minutos"),
            FragmentCriarReuniaoOutrosAdmin.ItemsTempoNotificacao(45, "45 minutos"),
            FragmentCriarReuniaoOutrosAdmin.ItemsTempoNotificacao(60, "1 hora"),
            FragmentCriarReuniaoOutrosAdmin.ItemsTempoNotificacao(1440, "1 dia")
        )
        ...
        var formattedEndDate = GlobalVariables.dataFormatadaCalendario
        ...
        edtxt_data_inicio_reuniao.isFocusable = false
        edtxt_data_inicio_reuniao.isFocusableInTouchMode = false
        edtxt_data_inicio_reuniao.setText(GlobalVariables.dataFormatadaCalendario)
        ...
        btn_criar_reuniao_entrevista.setOnClickListener {
            ...
            try {
                ...
                horarioInicio = Date.from(dataHora.toInstant(ZoneOffset.UTC))
            ...
            try {
                ...
                horarioFim = Date.from(dataHora.toInstant(ZoneOffset.UTC))
            } catch (dateTimeParseException: DateTimeParseException) {
                dateTimeParseException.printStackTrace()
        ...
        requireActivity().onBackPressedDispatcher.addCallback(viewLifecycleOwner) {
            ...
            fragment.replace(R.id.fragment_container, FragmentEventosCalendario())
            fragment.commit()
        }
    }
