...
class FragmentDetalhesReuniaoOportunidade : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txt_tipo_reuniao_label.text = getString(R.string.str_reuniao_sobre_oportunidade)
        ...
        btn_editar_reuniao.setOnClickListener {
            GlobalVariables.criarReuniaoOportunidade = false
