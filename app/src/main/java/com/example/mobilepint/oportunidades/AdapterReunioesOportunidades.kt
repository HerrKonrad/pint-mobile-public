...
class AdapterReunioesOportunidades(
    private val mcontext: Context,
    private val ReunioesList: ArrayList<ItemsReunioesOportunidades>
) :
    RecyclerView.Adapter<AdapterReunioesOportunidades.ReunioesViewHolder>(),
    Filterable {

    private var listaOriginal: ArrayList<ItemsReunioesOportunidades> = ArrayList(ReunioesList)
    private var listaAtual: ArrayList<ItemsReunioesOportunidades> = ArrayList(ReunioesList)
    ...
    override fun onBindViewHolder(holder: ReunioesViewHolder, position: Int) {
        ...
        holder.cardViewReunioes.setOnClickListener {
            ...
            transaction.replace(R.id.fragment_container, FragmentDetalhesReuniaoOportunidade())
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(p0: CharSequence?, results: FilterResults?) {
                listaAtual = results?.values as? ArrayList<ItemsReunioesOportunidades> ?: ArrayList()
