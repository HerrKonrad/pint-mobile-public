...
class AdapterReunioesEntrevistas(
    private val mcontext: Context,
    private val ReunioesList: ArrayList<ItemsReunioesEntrevistas>
) :
    RecyclerView.Adapter<AdapterReunioesEntrevistas.ReunioesViewHolder>(),
    Filterable {

    private var listaOriginal: ArrayList<ItemsReunioesEntrevistas> = ArrayList(ReunioesList)
    private var listaAtual: ArrayList<ItemsReunioesEntrevistas> = ArrayList(ReunioesList)
    ...
    override fun onBindViewHolder(holder: ReunioesViewHolder, position: Int) {
        ...
        holder.cardViewReunioes.setOnClickListener {
            ...
            transaction.replace(R.id.fragment_container, FragmentDetalhesReuniaoEntrevista())
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            ...
            override fun publishResults(p0: CharSequence?, results: FilterResults?) {
                listaAtual = results?.values as? ArrayList<ItemsReunioesEntrevistas> ?: ArrayList()
